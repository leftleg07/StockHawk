...
public class TestApiService {
    ...
    public void testQuotes() throws Exception {
        ...
        ArrayList batch = Utils.quoteJsonToContentVals(jsonStockStr, mContentResolver, false);
    ...
    public void testQuote() throws Exception {
        ...
        ArrayList batch = Utils.quoteJsonToContentVals(jsonStr, mContentResolver, false);
        if (batch != null && batch.size() > 0) {
            mContentResolver.applyBatch(QuoteProvider.AUTHORITY, batch);
        }
